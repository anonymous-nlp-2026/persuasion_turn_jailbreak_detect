# Plan 017: MLM continued pretraining control.
# Fine-tunes DeBERTa-v3-base with masked language modeling on plan_002 user turns.
# No classification labels. Tests whether domain exposure alone enables OOD generalization.
...
def parse_args():
    ...
    p.add_argument("--output_dir", type=str, default="checkpoints/plan_017_mlm")
...
def main():
    ...
    print(f"MLM continued pretraining complete. Best val loss: {best_val_loss:.4f}")
