"""MF1: Binary model (seed=456) DD OOD eval."""
...
def main():
    print("=== MF1: Binary Model (seed=456) DD OOD Eval ===")
    ...
    print("\nLoading binary DeBERTa (seed=456)...")
    binary_enc = load_binary_encoder(PROJ / "checkpoints/mf1_binary_seed456/deberta_multitask/best")
    binary_gru = load_gru(PROJ / "checkpoints/mf1_binary_seed456/gru/treatment/best.pt")
    print("  Loaded.")
    ...
    out_path = PROJ / "results/mf1_binary_seed456.json"
