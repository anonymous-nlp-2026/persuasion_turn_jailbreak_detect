...
def main():
    ...
    output_path = args.output or os.path.join(OUTPUT_DIR, "actorattack_all.jsonl")
    ...
    ood_dir = "./data/actorattack_ood"
    os.makedirs(ood_dir, exist_ok=True)
    ood_path = os.path.join(ood_dir, "actorattack_all.jsonl")
    with open(ood_path, "w") as f:
        for c in all_conversations:
            f.write(json.dumps(c, ensure_ascii=False) + "\n")
    print(f"Also saved to {ood_path}")
